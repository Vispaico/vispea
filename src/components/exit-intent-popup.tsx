...
export function ExitIntentPopup() {
  ...
  return (
    <div
      className="fixed inset-0 z-[80] flex items-center justify-center bg-slate-950/90 px-4 py-6"
    ...
    >
      <div
        className="relative flex w-full max-w-4xl flex-col gap-8 overflow-hidden border-4 border-black bg-[#fef3c7] p-8 text-slate-900 shadow-[12px_12px_0_#000] sm:p-10"
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <h2 id="exit-intent-title" className="text-4xl font-black uppercase leading-tight text-slate-900 drop-shadow-[4px_4px_0_#f472b6] sm:text-5xl">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="relative rounded-2xl border-4 border-black bg-white/90 p-6 shadow-[8px_8px_0_#000]">
          ...
          <div className="flex flex-col gap-4 text-sm font-semibold uppercase tracking-[0.2em] text-slate-800">
            <div className="flex items-start gap-3 border-2 border-dashed border-black/70 bg-white/70 px-4 py-3 shadow-[6px_6px_0_#000]">
